...
module.exports = {
    ...
    publicAnnouncementIntervalMs: parseInt(process.env.PUBLICANNOUNCEMENTINTERVALMS || 3600000, 10),
    startPublicAnnouncementsAfterMs: parseInt(process.env.STARTPUBLICANNOUNCEMENTSAFTERMS || 1200000, 10),
